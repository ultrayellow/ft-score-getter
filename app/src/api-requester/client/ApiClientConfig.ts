...
export class ApiClientConfig {
  ...
  static readonly DEFAULT_CLIENT_RATE_LIMIT_PER_SEC_KEY = 'CLIENT_RATE_LIMIT_PER_SEC';
  static readonly DEFAULT_CLIENT_RATE_LIMIT_PER_HOUR_KEY = 'CLIENT_RATE_LIMIT_PER_HOUR';
  ...
  constructor(
    ...
    try {
      ...
      this.rateLimitPerHour = parseInt(EnvReader.getEnv(rateLimitPerHourEnvKey));
    } catch {
      // todo
